...
public class DataDriven {
    ...
    public List<String> obtenerDatosDePrueba(String tituloCP) throws IOException {
        ...
        file = new FileInputStream(prop.obtenerProperty("rutaExcel"));
        ...
        for (int i = 0; i < cantidadDeHojasExcel; i++) {
            if (excel.getSheetName(i).equalsIgnoreCase(prop.obtenerProperty("nombreHojaExcel"))) {
                //Encontre la hoja
                ...
                while (celda.hasNext()) {
                    ...
                    if (celdaSeleccionada.getStringCellValue().equalsIgnoreCase(prop.obtenerProperty("tituloCp"))) {
